...
export const SidePanel = ({
  ...
  const speciesImageMap = useSpeciesImages(
                        ...
                        <Stack space={12}>
                          ...
                          <Inline justify="between" align="centre">
                            ...
                            {highestConfidenceObservation ? (
                              <Badge style={{backgroundColor: 'var(--color-state-warning-strong)', color: 'white'}}>
                          ...
                          proprietaryObservations.map(
                            (observation, observationIndex) => {
                              const speciesImageUrl =
                                speciesImageMap[observation.scientificName] ??
                                null;
