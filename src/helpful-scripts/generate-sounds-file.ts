...
const parseCliOptions = (argumentsList: Array<string>): CliOptions => {
...
const toFlagMap = (argumentsList: Array<string>): Map<string, string> => {
...
const readTabularFile = (inputPath: string): Array<JsonRecord> => {
...
const buildTypeScriptModule = (exportName: string, rows: Array<JsonRecord>): string => {
